...
public class SideSlider {
    ...
    public SideSlider(String movie_slide, String movie_type, String movie_thumbnail, String movie_url, String movie_name, String movie_description, String movie_category) {
